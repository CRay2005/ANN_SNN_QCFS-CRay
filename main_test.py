...
parser.add_argument('-Tp', '--timep', default=0, type=int, help='snn simulation time')
...
def main():
    ...
    model.set_T(args.time, args.timep)
    model.set_L(8)
    ...
    acc = val(model, test_loader, device, args.time, args.timep)
    print(f"acc:{acc}")
